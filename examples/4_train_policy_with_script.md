...
```bash
python lerobot/scripts/train.py hydra.run.dir=outputs/train/diffusion device=cuda training.offline_steps=800000 training.save_model=true training.save_freq=50000 wandb.enable=false 

python train.py hydra.run.dir=outputs/train/diffusion device=cuda training.offline_steps=800000 training.save_model=true training.save_freq=10000 wandb.enable=false > output.log 2>&1
```
